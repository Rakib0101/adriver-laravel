(() => {
    ...
    function Ht(e) {
        T = e.reactive, L = e.release, D = t => e.effect(t, {
            scheduler: r => {
                tt ? Kt(r) : r()
            }
        }), rt = e.raw
    ...
    function vn() {
        ue = ue.concat(at.takeRecords()), ue.length && !st && (st = !0, queueMicrotask(() => {
            Sn(), st = !1
        }))
    }
    ...
    function Re(e, t = () => {}) {
        let r = {
            ...
            _x_interceptor: !0,
            initialize(n, i, o) {
                return e(this.initialValue, () => An(n, i), s => dt(n, i, s), i, o)
            }
        };
        return t(r), n => {
...
`:""}`, t), setTimeout(() => {
    ...
    function le(e, t, r) {
        ...
        let n = {};
        return t.map(pr((o, s) => n[o] = s)).filter(hr).map(Mn(n, r)).sort(Nn).map(o => Rn(e, o))
    }

    function bt(e) {
        return Array.from(e).map(pr()).filter(t => !hr(t))
    }
    var gt = !1,
        de = new Map,
        dr = Symbol();
    ...
    function pe(e, t) {
        return Array.isArray(t) ? xr(e, t.join(" ")) : typeof t == "object" && t !== null ? Pn(e, t) : typeof t == "function" ? pe(e, t()) : xr(e, t)
    }
    ...
    p("transition", (e, {
        ...
        typeof n == "function" && (n = i(n)), n !== !1 && (!n || typeof n == "boolean" ? $n(e, r, t) : Ln(e, n, t))
    });
    ...
    function Er(e, t) {
        e._x_dataStack && (t._x_dataStack = e._x_dataStack, t.setAttribute("data-has-alpine-state", !0)), I = !0, Sr(() => {
            v(t, (r, n) => {
                n(r, () => {})
            })
        }), I = !1
    ...
    function vr(e, t) {
        t._x_dataStack || (t._x_dataStack = e._x_dataStack), I = !0, vt = !0, Sr(() => {
            jn(t)
        }), I = !1, vt = !1
    }
    ...
    function _e(e, t, r, n = []) {
        switch (e._x_bindings || (e._x_bindings = T({})), e._x_bindings[t] = r, t = n.includes("camel") ? Wn(t) : t, t) {
            case "value":
                Bn(e, r);
                break;
            case "style":
    ...
    function Bn(e, t) {
        ...
        else if (e.type === "checkbox") Number.isInteger(t) ? e.value = t : !Array.isArray(t) && typeof t != "boolean" && ![null, void 0].includes(t) ? e.value = String(t) : Array.isArray(t) ? e.checked = t.some(r => Or(r, e.value)) : e.checked = !!t;
    ...
    function Cr(e, t, r) {
        [null, void 0, !1].includes(r) && Gn(t) ? e.removeAttribute(t) : (Tr(t) && (r = t), Vn(e, t, r))
    }
    ...
    function je({
        ...
        let i = !0,
            o, s, a, c, l = D(() => {
                let u, d;
                i ? (u = e(), n(JSON.parse(JSON.stringify(u))), d = r(), i = !1) : (u = e(), d = r(), a = JSON.stringify(u), c = JSON.stringify(d), a !== o ? (d = r(), n(u), d = u) : (t(JSON.parse(c ? ? null)), u = d)), o = JSON.stringify(u), s = JSON.stringify(d)
            });
        return () => {
            L(l)
        }
    ...
    function Fr(e) {
        return Object.entries(Lr).forEach(([t, r]) => {
    ...
    function Kr(e, t) {
        return Object.entries(jr).forEach(([r, n]) => {
            Object.defineProperty(e, r, {
                get() {
                    return (...i) => n.bind(t)(...i)
                },
    ...
    var As = At(Yn + ",async,autofocus,autoplay,controls,default,defer,disabled,hidden,loop,open,required,reversed,scoped,seamless,checked,muted,multiple,selected");
    ...
    var Qn = Object.prototype.toString,
        Hr = e => Qn.call(e),
        Ot = e => Hr(e).slice(8, -1);
    var Ke = e => Zn(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e;
    var ze = e => {
    ...
    function ii(e, t) {
        ...
        return r.id = ni++, r.allowRecurse = !!t.allowRecurse, r._isEffect = !0, r.active = !0, r.raw = e, r.deps = [], r.options = t, r
    }
    ...
    function M(e, t, r) {
        ...
        let i = n.get(r);
        i || n.set(r, i = new Set), i.has(P) || (i.add(P), P.deps.push(i), P.options.onTrack && P.options.onTrack({
            effect: P,
            target: e,
            type: t,
            key: r
    ...
    function H(e, t, r, n, i, o) {
        ...
        else if (r === "length" && K(e)) s.forEach((u, d) => {
            (d === "length" || d >= n) && c(u)
        });
    ...
    var ai = At("__proto__,__v_isRef,__isVue"),
        Qr = new Set(Object.getOwnPropertyNames(Symbol).map(e => Symbol[e]).filter(Be)),
        ci = en();
    var li = en(!0);
    var Vr = ui();
    ...
    function en(e = !1, t = !1) {
        return function(n, i, o) {
            ...
            if (i === "__v_raw" && o === (e ? t ? Oi : on : t ? Ai : nn).get(n)) return n;
            let s = K(n);
            if (!e && s && ge(Vr, i)) return Reflect.get(Vr, i, o);
            let a = Reflect.get(n, i, o);
            return (Be(i) ? Qr.has(i) : ai(i)) || (e || M(n, "get", i), t) ? a : Nt(a) ? !s || !Ke(i) ? a.value : a : xe(a) ? e ? sn(a) : Je(a) : a
        }
    }
    var fi = di();
    ...
    y("data", e => Ce(e));
    y("root", e => U(e));
    y("refs", e => (e._x_refs_proxy || (e._x_refs_proxy = F(Ri(e))), e._x_refs_proxy));
    ...
    p("teleport", (e, {
        ...
        let i = B(() => document.querySelector(r), () => Mi)();
    ...
    function oe(e, t, r, n) {
        let i = e,
            ...
            s = {},
            a = (c, l) => u => l(c, u);
        if (r.includes("dot") && (t = Ni(t)), r.includes("camel") && (t = Pi(t)), r.includes("passive") && (s.passive = !0), r.includes("capture") && (s.capture = !0), r.includes("window") && (i = window), r.includes("document") && (i = document), r.includes("debounce")) {
    ...
    function ki(e, t) {
        ...
        if (r.length === 0 || r.length === 1 && dn(e.key).includes(r[0])) return !1;
        let i = ["ctrl", "shift", "alt", "meta", "cmd", "super"].filter(o => r.includes(o));
        return r = r.filter(o => !i.includes(o)), !(i.length > 0 && i.filter(s => ((s === "cmd" || s === "super") && (s = "meta"), e[`${s}Key`])).length === i.length && dn(e.key).includes(r[0]))
    }
    ...
    p("model", (e, {
        ...
        if (t.includes("fill") && ([null, ""].includes(c()) || e.type === "checkbox" && Array.isArray(c())) && e.dispatchEvent(new Event(u, {})), e._x_removeModelListeners || (e._x_removeModelListeners = {}), e._x_removeModelListeners.default = d, i(() => e._x_removeModelListeners.default()), e.form) {
    ...
    p("for", (e, {
        ...
        e._x_prevKeys = [], e._x_lookup = {}, r(() => Bi(e, i, o, s)), n(() => {
    ...
    function Bi(e, t, r, n) {
        ...
        r(s => {
            ...
            for (let f = 0; f < m.length; f++) {
                let [g, b] = m[f], E = a[g], A = a[b], X = document.createElement("div");
                h(() => {
                    A || S('x-for ":key" is undefined or invalid', o), A.after(X), E.after(A), A._x_currentIfEl && A.after(A._x_currentIfEl), X.before(E), E._x_currentIfEl && E.after(E._x_currentIfEl), X.remove()
                }), A._x_refreshXForScope(l[u.indexOf(b)])
            }
            for (let f = 0; f < d.length; f++) {
                let [g, b] = d[f], E = g === "template" ? o : a[g];
                E._x_currentIfEl && (E = E._x_currentIfEl);
                let A = l[b],
                    X = u[b],
                    se = document.importNode(o.content, !0).firstElementChild,
                    Bt = T(A);
                N(se, Bt, o), se._x_refreshXForScope = gn => {
                    Object.entries(gn).forEach(([xn, yn]) => {
                        Bt[xn] = yn
                    })
                }, h(() => {
                    E.after(se), v(se)
                }), typeof X == "object" && S("x-for key cannot be an object, it must be a string or an integer", o), a[X] = se
            }
