<template>
  <div>
    ...
    <Breadcrumb :links="[
        ...
        { label: 'Privacy and Security', url: '#' },
      ]" :title="'Help Center'" />
    <div class="py-[100px]">
      <div class="container">
        <div class="flex lg:justify-between lg:items-start flex-col-reverse gap-8 lg:flex-row">
          ...
          <div class="w-full lg:max-w-[732px]">
            ...
            <img :src="SupportDetail" alt="" class="w-full h-[312px] object-cover mb-[38px]" />
...
<script setup>
  ...
  import SupportDetail from "../../assets/images/img/support-detail.png";
</script>
<style>
