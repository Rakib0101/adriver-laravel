      ...
      <div class="container">
        <div class="flex flex-row justify-between gap-6">
          <div class="w-full">
            <div class="blog-detail w-full max-w-[872px]">
              <p class="flex gap-2 items-center text-sm text-gray-700 mb-3">
                <a
                  href="#"
                  class="inline-flex gap-2 items-center text-blue-500"
                >
                  <layers-icon />
                  <p class="font-medium">Travel</p>
                </a>
                ...
                <span class="flex gap-2 items-center"
                  ...
                  <div class="flex gap-2 items-center">
                    <a href="#" class="inline-flex"><Facebook :size="16" /></a>
                    <a href="#" class="inline-flex"><Twitter :size="16"/></a>
                    <a href="#" class="inline-flex"><Pinterest :size="16" /></a>
                    <a href="#" class="inline-flex"><Link :size="16" /></a>
                  </div>
                </span>
              </p>
              ...
              <div
                class="px-8 pt-8 pb-6 bg-gray-50 border-l-4 border-primary-500"
              >
                <div class="mb-2">
                  <qoute-icon />
                </div>
                <q class="text-base text-gray-900"
              ...
              <h3
                class="text-lg text-gray-900 font-semibold font-display pt-8 mb-3"
              >
            ...
            <div>
              <h2
                class="text-[32px] leading-10 font-semibold font-display line-clamp-1 mt-[48px] mb-6"
              >
                Related Blog Post
              </h2>
          ...
          <div class="sidebar lg:max-w-[312px] w-full">
            <div
              class="border border-gray-100 flex flex-col gap-4 mb-6 rounded-lg p-5"
            >
              ...
              >
                <h2
                  class="text-base text-center font-semibold text-white mb-1.5"
                >
                  Technology
                </h2>
                <p class="flex justify-center count">
                  <span
                    class="text-xs bg-[rgba(255,255,255,0.16)] rounded font-medium text-white inline-flex py-1 px-2.5"
                    >34,234</span
                  >
                </p>
              </a>
...
.category-card {
  background: linear-gradient(
    ...
    url("../../assets/images/img//category-01.png");
  border-radius: 4px;
}
.category-card:hover{
    background: linear-gradient(0deg, rgba(23, 30, 21, 0.72) 0%, rgba(23, 30, 21, 0.72) 100%), url("../../assets/images/img//category-01.png");
}
