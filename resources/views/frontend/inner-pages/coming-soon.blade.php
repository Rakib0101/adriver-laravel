...
@section('content')
    <div class="coming-soon w-full min-h-screen relative">
        <div class="w-full h-full flex justify-center pt-32 relative z-50">
            <div class="text-center">
                <a href="/home">
                    <img src="{{ asset('frontend/assets/images/img/coming-soon-logo.svg') }}" alt=""
                        class="mx-auto mb-8" />
                </a>
                <h2
        ...
        <img src="{{ asset('frontend/assets/images/img/coming-soon-left.png') }}" alt=""
            class="absolute top-0 left-0 hidden xl:block z-30" />
        <img src="{{ asset('frontend/assets/images/img/coming-soon-right.png') }}" alt=""
...
@section('scripts')
    <script>
        ...
        const targetDate = new Date('2023-11-15T00:00:00Z');
...
<style>
    .coming-soon {
        background: linear-gradient(180deg,
            ...
            url("{{ asset('frontend/assets/images/img/coming-soon-bg.png') }}");
    }
</style>
