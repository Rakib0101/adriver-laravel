                ...
                <div class="flex flex-col xl:flex-row gap-6">
                    <div class="sidebar xl:max-w-[312px] w-full">
                        <div class="border border-gray-100 flex flex-col gap-4 mb-6 rounded-lg p-5">
                            ...
                            <div class="2xl:flex flex-col gap-4 place-items-center grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                                <template x-for="item in 6" :key="item">
                                    <div href="#" class="w-full h-[88px] category-card px-6 py-4">
                        ...
                        <div class="bg-gray-50 rounded-lg p-5">
                            ...
                            <div class="2xl:flex flex-col grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="grid gap-6 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 place-items-center">
                            <template x-for="item in 6" :key="item">
                                {{-- <x-frontend.inner-pages.blog.blog-card href="'/blog-detail'" category="blog.category"
