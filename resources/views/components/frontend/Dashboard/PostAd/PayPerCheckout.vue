<template>
    <div class="container">
        <div class="flex flex-wrap gap-5 py-9 items-center justify-between">
            <h2 class="text-xl md:text-[40px] md:leading-[48px] font-display font-semibold text-gray-900">
                Choose Your Payment Method
            </h2>
        </div>
        <div class="flex flex-col lg:flex-row lg:justify-center justify-center gap-5  md:gap-10 xl:gap-16 items-strat">
            <div>
                <div class="max-w-[872px] mx-auto">
                    <div class="pb-[100px]">
                        <div>
                            <h3 class="text-lg mb-4 font-display font-medium text-gray-900">
                                Payment Method
                            </h3>
                                ...
                                <form action="">
                                    <div class="mb-[18px] relative">
                                        <label class="flex w-full text-sm mb-2 font-display font-normal text-gray-900"
                                            for="card-num">Card Number</label>
                                        <input
                                        ...
                                        <label for="card-num"
                                            class="absolute bottom-3 left-[18px]"><credit-card /></label>
                                    </div>
                                    <div class="grid lg:grid-cols-3 grid-cols-1 gap-[18px]">
                                        <div>
                                            <label
                                                class="flex w-full text-sm mb-2 font-display font-normal text-gray-900"
                                                for="card-num">Name on Card</label>
                                            <input
                                        ...
                                        <div>
                                            <label
                                                class="flex w-full text-sm mb-2 font-display font-normal text-gray-900"
                                                for="card-num">Expiry Date</label>
                                            <input
                                                class="flex w-full px-3 py-3 rounded-md shadow-[0p_3px_14px_rgba(23,30,21,0.03)] outline-none focus:border-primary-500 focus:shadow-[0px_8px_24px_rgba(88,179,43,0.12)] border border-gray-100"
                            ...
                            <div class="flex justify-end" v-if="!payCheckout">
                                <primary-button @click="$emit('completePayCheckout')">
            ...
            <PostSummery class="min-w-full md:w-fit md:min-w-[384px] md:max-h-[396px]" />
        </div>
    </div>
</template>
<script setup>
