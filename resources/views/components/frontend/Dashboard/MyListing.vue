        ...
        <div class="">
            <div class="border border-gray-100 my-12 shadow-[0px_8px_24px_rgba(23,30,21,0.04)] rounded-xl py-6">
                ...
                <div class="overflow-x-auto scrollbar-hide">
                    <table class="listing-table table-auto w-full responsive">
                        <thead>
                            <tr class="uppercase">
                                <th class="px-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-[364px]">
                                    AD
                                </th>
                                <th class="pr-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-[124px]">
                                    Price
                                </th>
                                <th class="pr-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-[170px]">
                                    Ad Status
                                </th>
                                <th class="pr-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-[148px]">
                                    Plan Type
                                </th>
                                <th class="pr-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-[148px]">
                                    Ad Type
                                ...
                                <th class="pr-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-10">
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="hover:bg-gray-50 transition-all duration-300" v-for="(item, index) in 6" :key="item">
                                <td class="px-6 py-4 w-[364px]">
                                    <div class="flex items-center gap-3">
                                        <img :src="active01" alt="" class="w-24 h-[74px] rounded object-cover" />
                                        <div>
                                            <h2 class="text-gray-900 text-base font-medium font-display mb-1.5 line-clamp-2">
                                ...
                                <td class="pr-6 py-4 w-[124px]">
                                    <div>
                                        <h2 class="text-xl text-warning-500 font-display font-semibold mb-1.5 text-ellipsis whitespace-nowrap">
                                            $211.68
                                        </h2>
                                        <p class="text-sm font-display text-gray-500 text-ellipsis whitespace-nowrap">
                                            Fixed Price
                                ...
                                <td class="pr-6 py-4 w-[148px]">
                                    <div class="flex gap-2 text-[#1F85E2]">
                                        <credit-card />
                                        <div>
                                            <p class="text-xs text-gray-500 font-display mb-0.5 text-ellipsis whitespace-nowrap">
                                                Pricing Plan
                                            </p>
                                            <h2 class="text-sm text-gray-900 font-display font-medium text-ellipsis whitespace-nowrap">
                                                Standard Plan
                                            </h2>
                                        </div>
                                    </div>
                                ...
                                <td class="pr-6 py-4 w-10 dropdown-btn">
                                    <button @click="toggleDropdown(index)" class="p-3 relative bg-gray-50 border border-gray-50 w-12 h-12 rounded-md hover:bg-white hover:border-primary-500 dot">
                                        <dots-icon />
                                        <div v-if="activeDropdown === index" class="dropdown-list py-3 bg-white w-[248px] mt-3 shadow-[0px_12px_32px_rgba(23,30,21,0.08)] border border-gray-100 absolute right-0 top-full rounded-md z-50">
                                            <ul>
                                                <li class="flex px-[18px] py-2 items-center gap-2 hover:bg-gray-50 text-gray-600 hover:text-gray-900">
                                                    <MarkSold />
                                                    Mark As Sold
                                                </li>
                                                <li @click="togglePromotion = !togglePromotion" class="flex px-[18px] py-2 items-center gap-2 hover:bg-gray-50 text-gray-600 hover:text-gray-900">
                                                    <ListingPromotion />
                                                    Listing Promotion
                                                </li>
                                                <li class="flex px-[18px] py-2 items-center gap-2 hover:bg-gray-50 text-gray-600 hover:text-gray-900">
                ...
                <pagination />
                <PromoteListing v-if="togglePromotion" @checkClick="isOverlayClick" />
            </div>
        </div>
    </div>
</template>
