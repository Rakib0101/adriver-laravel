        ...
        <div class="max-w-[872px] mx-auto pt-12 md:pb-[68px]">
            ...
            <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
                ...
                <div class="mb-[18px]">
                    ...
                    <x-frontend.custom-input.input type="text" placeholder="tags 1, tag 2, tag 3" />
                </div>
                <div class="flex flex-col sm:flex-row gap-[18px]">
                    <div class="w-full">
                        ...
                        <div class="flex gap-3 justify-between">
                            ...
                            <div class="flex w-full gap-3 items-center custom-radio">
                                <input type="radio" name="auth" id="refurbished-2" />
                                <label for="refurbished-2"
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex gap-3 justify-between">
                            <div class="flex w-full gap-3 items-center custom-radio">
                                <input type="radio" name="condition" id="used-2" />
                                <label for="used-2" class="cursor-pointer select-none flex w-full">Used</label>
                            </div>
                            <div class="flex w-full gap-3 items-center custom-radio">
                                <input type="radio" name="condition" id="new-2" />
                                <label for="new-2" class="cursor-pointer select-none flex w-full">New</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
                ...
                <div class="">
                    ...
                    <x-frontend.custom-input.input type="text" placeholder="Ad price..." />
                </div>
            </div>
            <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
                <h3 class="mb-[18px] text-lg text-gray-900 font-display font-semibold">
                ...
                <div class="flex flex-col md:flex-row mb-[18px] gap-[18px]">
                    <div class="w-full">
                        <label for="category" class="text-sm font-normal font-display mb-1.5 flex w-full">Custom Field
                            1</label>
                        <x-frontend.custom-input.input type="text" placeholder="Custom field input field" />
                    </div>
                    <div class="w-full">
                        <label for="category" class="text-sm font-normal font-display mb-1.5 flex w-full">Custom Field
                            2</label>
            ...
            <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
                ...
                <div>
                    <label
                        class="relative inline-flex cursor-pointer w-full xl:h-[596px] md:h-96 h-60 rounded-xl mb-6">
