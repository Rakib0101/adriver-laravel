      ...
      <div class="max-w-[872px] mx-auto pt-12 md:pb-[68px]">
        <div class="flex flex-col md:flex-row gap-6 justify-between md:items-center mb-8">
          <div class="w-full max-w-[464px]">
            <h2
              class="text-3xl md:text-xl md:text-[40px] md:leading-[48px] mb-3 font-display font-semibold text-gray-900">
              Ad Details
            </h2>
        ...
        <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
          ...
          <div class="mb-[18px]">
            ...
            <input-field type="text" placeholder="Ad tittle" />
          </div>
          <div class="mb-[18px]">
          ...
          <div class="flex flex-col sm:flex-row gap-[18px]">
            <div class="w-full">
              ...
              <div class="flex gap-3 justify-between">
                <div class="flex w-full gap-3 items-center custom-radio">
                  <input type="radio" name="auth" id="original-2" />
                  <label for="original-2" class="cursor-pointer select-none flex w-full">Original</label>
                </div>
                <div class="flex w-full gap-3 items-center custom-radio">
                  <input type="radio" name="auth" id="refurbished-2" /><label for="refurbished-2"
            ...
            <div class="w-full">
              ...
              <div class="flex gap-3 justify-between">
                <div class="flex w-full gap-3 items-center custom-radio">
                  <input type="radio" name="condition" id="used-2" /><label for="used-2"
                    class="cursor-pointer select-none flex w-full">Used</label>
                </div>
                <div class="flex w-full gap-3 items-center custom-radio">
                  <input type="radio" name="condition" id="new-2" /><label for="new-2"
        ...
        <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
          ...
          <div class="flex flex-col md:flex-row mb-[18px] gap-[18px]">
            <div class="w-full">
              <label for="category" class="text-sm font-normal font-display mb-1.5 flex w-full">Price Type</label>
              <div>
                <Multiselect placeholder="Select price type" v-model="value" :options="options" />
              </div>
            </div>
            <div class="w-full">
              <label for="category" class="text-sm font-normal font-display mb-1.5 flex w-full">Currency</label>
              <div>
                <Multiselect placeholder="Select currency" v-model="value" :options="options" />
              </div>
            </div>
          </div>
          <div class="">
        ...
        <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
          ...
          <div>
            <label for="description" class="text-sm font-normal font-display mb-1.5 flex w-full">Description</label>
            <description-editor />
          </div>
        </div>
        <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
          ...
          <div class="flex flex-col md:flex-row mb-[18px] gap-[18px]">
            <div class="w-full">
              <label for="category" class="text-sm font-normal font-display mb-1.5 flex w-full">Custom Field 1</label>
            ...
            <div class="w-full">
              <label for="category" class="text-sm font-normal font-display mb-1.5 flex w-full">Custom Field 2</label>
              <input type="text" placeholder="Custom field input field"
                class="flex w-full px-[18px] py-3 rounded-md shadow-[0p_3px_14px_rgba(23,30,21,0.03)] outline-none focus:border-primary-500 focus:shadow-[0px_8px_24px_rgba(88,179,43,0.12)] border border-gray-100" />
            </div>
          </div>
          <div class="flex flex-col md:flex-row gap-[18px]">
            <div class="w-full">
              <label for="category" class="text-sm font-normal font-display mb-1.5 flex w-full">Custom Field 3</label>
              <div>
                <Multiselect placeholder="Select a field" v-model="value" :options="options" />
              </div>
            </div>
            <div class="w-full relative">
              <label for="icon-input" class="text-sm font-normal font-display mb-1.5 flex w-full">Model</label>
        ...
        <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-8">
          ...
          <div>
            ...
            <div v-if="imgGallery" class="flex gap-3 items-center">
              <div v-for="(img, i) in imgGallery" ref="image-list" :key="img" class="inline-flex relative">
                <img :src="img" class="w-[124px] h-[92px] object-cover border border-gray-100 rounded"
                  alt="Profile Picture" />
        ...
        <div class="pt-8 md:py-8 border-t border-gray-100">
          <div class="flex justify-between items-center">
            <secondary-button>
              <info-circle />
              <span>Posting Guide</span>
            </secondary-button>
            <primary-button @click="$emit('completeStepTwo')">
              <span>Post Ads</span>
              <button-arrow />
            </primary-button>
          </div>
