        ...
        <div class="max-w-[872px] mx-auto pt-12 md:pb-[68px]">
            ...
            <div class="sm:p-8 p-5 bg-gray-50 rounded-xl mb-6 listing-cat">
                ...
                <div class="flex flex-col md:flex-row mb-[18px] gap-[18px]">
                    <div class="w-full">
                        <label for="category"
                            class="text-sm font-normal font-display mb-1.5 flex w-full">Category</label>
                        <div>
                    ...
                    <div class="w-full">
                        <label for="category" class="text-sm font-normal font-display mb-1.5 flex w-full">Sub
                            Category</label>
                        <div>
                            <select class="relative !w-full sorting-select select2" placeholder="Sort By :">
                                <option value="option1">Option 1</option>
                ...
                <div class="flex flex-col md:flex-row gap-[18px]">
                    ...
                    <div class="w-full">
                        ...
                        <div>
                            <x-frontend.custom-input.input placeholder="Enter Model" v-model="value" type="text"
                                :class="'!text-gray-500'" />
                        </div>
                    </div>
                </div>
                    ...
                    <label class="flex gap-2 items-start custom-checkbox h-[84px]">
                        ...
                        <label for="forsell2"
                            ...
                            <div class="flex w-full flex-col ml-3">
                                <h2
                                    class="text-gray-900 uppercase text-sm mb-1.5 leading-[100%] font-display font-semibold">
                                    For Sell
                                </h2>
