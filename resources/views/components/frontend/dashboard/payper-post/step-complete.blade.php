<div class="container">
    ...
    <div class="flex flex-col lg:flex-row lg:justify-center justify-center gap-5  md:gap-10 xl:gap-16 items-strat">
            ...
            <div class="max-w-[872px] mx-auto">
                <div class="pb-[100px]">
                    <div>
                        ...
                        <div class="flex justify-end" @click="completePayCheckout">
        ...
        <div class="min-w-full md:w-fit md:min-w-[384px] md:max-h-[396px]">
            <x-frontend.dashboard.ad-post.post-summery />
        </div>
    </div>
</div>
