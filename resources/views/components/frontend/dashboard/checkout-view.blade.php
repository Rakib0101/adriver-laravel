                    ...
                    <div class="flex mb-8 gap-4 justify-center flex-wrap">
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="debit-card"
                                ...
                                <img src="{{ asset('frontend/assets/images/img/payment-method-01.png') }}"
                                    alt="" />
                        ...
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="bank"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-02.png') }}"
                                    alt="" />
                                <p>Offline/Bank</p>
                            </label>
                        </div>
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="paypal"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-03.png') }}"
                                    alt="" />
                                <p>Paypal</p>
                            </label>
                        </div>
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="razorpay"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-04.png') }}"
                                    alt="" />
                                <p>Razorpay</p>
                            </label>
                        </div>
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="paystack"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-05.png') }}"
                                    alt="" />
                                <p>Paystack</p>
                            </label>
                        </div>
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="stripe"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-06.png') }}"
                                    alt="" />
                                <p>Stripe</p>
                            </label>
                        </div>
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="sslcommerz"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-07.png') }}"
                                    alt="" />
                                <p>SSLCommerz</p>
                            </label>
                        </div>
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="instamojo"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-08.png') }}"
                                    alt="" />
                                <p>Instamojo</p>
                            </label>
                        </div>
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="midtrans"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-09.png') }}"
                                    alt="" />
                                <p>Midtrans</p>
                            </label>
                        </div>
                        <div class="payment-box relative w-[160px] h-[108px]">
                            ...
                            <label for="flutterwave"
                                class="payment-method flex flex-col justify-center items-center cursor-pointer rounded-lg border border-gray-100 absolute top-0 left-0 w-full h-full">
                                <img src="{{ asset('frontend/assets/images/img/payment-method-10.png') }}"
                                    alt="" />
                                <p>Flutterwave</p>
                            </label>
                        </div>
                    ...
                    <div class="bg-gray-50 p-8 rounded-xl mb-8">
                        ...
                        <form action="">
                            <div class="mb-[18px] relative">
                                <label class="flex w-full text-sm mb-2 font-display font-normal text-gray-900"
                                    for="card-num">Card
                                    Number</label>
                                <input
                                ...
                                <label for="card-num" class="absolute inline-flex justify-center items-center bottom-3.5 left-[18px]">
                            ...
                            <div class="grid lg:grid-cols-3 grid-cols-1 gap-[18px]">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        id="cvc" type="text" />
                                    <label for="cvc"
                                        class="absolute bottom-3 right-[18px]"><question-mark /></label>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="md:flex justify-end" x-cloak x-show="!payCheckout">
                        <div @click="completeCheckout">
                            <x-frontend.button.primary-button class="w-full md:w-max">
