            ...
            <form class="flex lg:flex-row flex-col gap-[56px]">
                <div class="lg:w-1/2 w-full">
                    <div class="flex flex-col sm:flex-row justify-start items-center gap-6 bg-gray-50 p-8 rounded-md">
                        <label class="relative inline-flex cursor-pointer min-w-[166px] w-[166px] h-[166px] min-h-[166px] rounded-full">
                            <input type="file" @change="onFileChange" hidden accept="image/*" />
                            <div class="absolute border-2 border-dashed border-gray-100 top-0 right-0 bottom-0 left-0 w-full h-full rounded-full flex justify-center items-center">
                                <div class="text-center">
                                    <i class="ph-bold ph-upload-simple mb-3.5 mx-auto text-primary-500 text-[32px] leading-8"></i>
                                    <p class="text-sm font-medium font-display text-gray-900">
                                        Upload Picture
                                    </p>
                                </div>
                            </div>
                            <img x-if="profilePicture" src=""
                ...
                <div class="lg:w-1/2 w-full">
                    <div class="mb-[18px]">
                        ...
                        <x-frontend.custom-input.input type="text" id="name" />
                    </div>
                    <div class="mb-[18px]">
                        <label for="dname" class="flex w-full text-sm text-gray-900 mb-1.5">Display Name</label>
                        <x-frontend.custom-input.input type="text" id="dname" />
                    </div>
                    <div class="mb-8">
                        <label for="email" class="flex w-full text-sm text-gray-900 mb-1.5">Email/Phone
                            Number</label>
                        <x-frontend.custom-input.input type="email" id="email" />
                    </div>
                    <div>
                        <x-frontend.button.primary-button>
                            <i class="ph-bold ph-check text-xl leading-5"></i>
                ...
                <div class="md:w-1/2 w-full">
                    <div class="sm:p-8 sm:bg-gray-50 rounded-lg">
                        ...
                        <div class="mb-[18px] relative">
                            ...
                            <x-frontend.custom-input.input type="url" id="url" class="'pl-[54px]'"
                        ...
                        <div class="mb-[18px] relative">
                            ...
                            <x-frontend.custom-input.input id="mail" type="email" class="'pl-[54px]'"
                        ...
                        <div class="mb-[18px] relative">
                            ...
                            <x-frontend.custom-input.input type="number" class="'pl-[54px]'" id="phone"
                                placeholder="+91" />
                        </div>
                        <div class="mb-8 relative">
                            <label for="whatsapp" class="flex w-full text-sm text-gray-900 mb-1.5">WhatsApp
                                Number</label>
                            <label for="whatsapp" class="absolute bottom-3 left-[18px]"><whatsapp-input /></label>
                            <x-frontend.custom-input.input type="number" class="'pl-[54px]'" id="whatsapp"
                                placeholder="+91" />
                        </div>
                        <div>
                            <x-frontend.button.primary-button>
            ...
            <div class="flex flex-col md:flex-row gap-6">
                <div class="md:max-w-[424px] w-full">
                    <div class="sm:p-8 sm:bg-gray-50 pt-4 sm:pt-8 rounded-lg">
                        ...
                        <div class="flex mb-3 gap-2 items-center">
                            ...
                            <label for="check1" class="cursor-pointer select-none text-base text-gray-900">Anyone can
                                visit my
                                profile</label>
                        </div>
                        <div class="flex mb-3 gap-2 items-center">
                            ...
                            <label for="check2" class="cursor-pointer select-none text-base text-gray-900">Anyone can
                                message
                                me</label>
                        </div>
                        <div class="flex mb-3 gap-2 items-center">
                            ...
                            <label for="check3" class="cursor-pointer select-none text-base text-gray-900">Anyone can
                                message via
                                Email</label>
                        </div>
                        <div class="flex mb-3 gap-2 items-center">
                            ...
                            <label for="check4" class="cursor-pointer select-none text-base text-gray-900">Anyone
                                can message via
                                Whatsapp</label>
                        </div>
                        <div class="flex mb-3 gap-2 items-center">
                            ...
                            <label for="check5" class="cursor-pointer select-none text-base text-gray-900">Show my
                                contact
                                information</label>
                        </div>
                        <div class="flex mb-3 gap-2 items-center">
                            ...
                            <label for="check6" class="cursor-pointer select-none text-base text-gray-900">Show my
                                reviews</label>
                        </div>
                        <div class="flex gap-2 items-center">
                            ...
                            <label for="check7" class="cursor-pointer select-none text-base text-gray-900">Show my
                                website
                                link</label>
                        </div>
                    </div>
                ...
                <div class="max-w-[872px] w-full sm:border-none border-t border-gray-100">
                    <div class="sm:p-8 sm:bg-gray-50 pt-4 sm:pt-8 rounded-lg">
                        ...
                        <div class="mb-[18px] relative">
                            <label for="curpassword" class="flex w-full text-sm text-gray-900 mb-1.5">Current
                                Password</label>
                            <x-frontend.custom-input.input type="showcurPassword ? 'text' : 'password'" id="curpassword"
                                class="'flex w-full'" />
                        ...
                        <div class="flex flex-col sm:flex-row gap-[18px] mb-8">
                            <div class="w-full relative">
                                <label for="npassword" class="flex w-full text-sm text-gray-900 mb-1.5">New
                                    Password</label>
                                <x-frontend.custom-input.input id="npassword" type="shownPassword ? 'text' : 'password'" />
                            ...
                            <div class="w-full relative">
                                <label for="cpassword" class="flex w-full text-sm text-gray-900 mb-1.5">Confirm
                                    Password</label>
                                <x-frontend.custom-input.input type="showcPassword ? 'text' : 'password'" id="cpasword" />
