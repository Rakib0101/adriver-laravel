            ...
            <div class="overflow-auto scrollbar-hide">
                <table class="listing-table table-auto w-full responsive">
                    <thead>
                        <tr>
                            <th
                                class="px-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-[27%]">
                                Name
                            </th>
                            <th
                                class="pr-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-[16%]">
                                Price
                            </th>
                            <th
                                class="pr-6 py-2 bg-gray-50 text-start text-xs text-gray-500 font-display font-medium min-w-[31%]">
                                Ad Status
                            </th>
                            <th
