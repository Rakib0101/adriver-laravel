<template>
  <div class="location-slider mx-5">
    <input type="range" min="0" max="20" step="1" ref="slider" v-model="sliderValue" @input="updateValue" />
    <div class="tooltip" :style="{ left: tooltipPosition }">{{ sliderValue }} </div>
...
<script>
  ...
  export default {
    setup() {
      ...
      return { slider, sliderValue, updateValue, tooltipVisible, tooltipPosition };
    },
  };
</script>
