<template>
  <div class="z-[999] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" v-if="isOtpVerify">
  ...
  <div class="overlay fixed top-0 left-0 w-full h-full bg-[#171E15]/70 z-[99]" @click="$emit('close')" v-if="isOtpVerify">
  </div>
</template>
