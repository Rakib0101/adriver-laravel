...
<template>
  <div class="mb-6">
    ...
    >
      <div class="flex justify-between lg:border-none border-b border-gray-100">
        ...
        <div
            ...
            <!-- <tag-icon /> -->
            <Multiselect class="list-type" placeholder="Select category..." v-model="value" :options="options2" />
        </div>
        <div
          class="relative lg:flex hidden gap-3 items-center lg:max-w-[312px] w-full border-r border-l border-gray-100 px-[18px]"
        >
    ...
    <div>
      <p
        class="lg:flex hidden gap-2 text-gray-900 text-sm font-medium overflow-x-auto"
      >
        Suggestion:
        <a
          href="#"
          class="text-gray-500 hover:text-primary-500 hover:underline transition-all duration-300"
          >Mobile Phones,</a
        >
        <a
          href="#"
