<div class="bg-gray-50 w-full">
    <div class="container">
        <div class="flex gap-16 justify-between items-center py-6">
            ...
            <div class="flex gap-3 item-center" x-show="isLoginUser" x-data="{ isLoginUser: true }">
                <div x-data="{ showMsg: false, showBell: false }" class="relative">
                    <div class=" bg-white inline-flex gap-3 items-center p-3 border border-gray-100 rounded-md shadow-[0px_3px_14px_rgba(23,30,21,0.02)]">
                        <!-- message button -->
            ...
            <div class="flex gap-3 item-center" x-data="{ isLoginUser: true }" x-show="!isLoginUser">
                <x-frontend.button.outline-primary type="button" @click="showModal = true">
                    Sign in
