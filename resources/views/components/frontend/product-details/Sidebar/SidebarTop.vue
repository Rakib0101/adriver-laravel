<template>
  <div class="border border-gray-100 rounded-lg px-8 pb-8 pt-6">
    <div
      class="flex lg:flex-col xl:flex-row gap-4 flex-row justify-between xl:items-center lg:items-start items-center">
      <div>
    ...
    <div>
      ...
      <div class="border-2 border-warning-50 p-5 cursor-pointer rounded-md bg-warning-50 hover:bg-warning-100 flex justify-start items-center gap-2 hover:border-warning-100 transition-all duration-300 font-display uppercase font-semibold text-sm tracking-[-0.01em] mb-3" @click="revealNo = !revealNo">
        <span class="text-danger-500"><phonecall-lg /></span>
        <div>
          <p class="text-gray-600 mb-1 capitalize">
            Click here to reveal phone numer.
          </p>
          <h2 class="text-gray-900 font-2xl font-semibold"><span v-if="!revealNo">+91816xxxxxxx</span> <span v-else>+91816234567</span></h2>
        </div>
      </div>
...
<script>
  ...
  import OutlinePrimary from "../../Button/OutlinePrimary.vue";
  import MessageSquare from "../../Icons/MessageSquare.vue";
  import MessageIcon from "../../Icons/MessageIcon.vue";
  import SecondaryButton from "../../Button/SecondaryButton.vue";
  import IconWhatsapp from "../../Icons/IconWhatsapp.vue";
  import PhoneNumber from "../../Button/PhoneNumber.vue";
  import PhonecallLg from "../../Icons/PhonecallLg.vue";
